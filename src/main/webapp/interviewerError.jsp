    ...
    <div class="container"> 
      ...
      <nav>
        <ul class="primary-nav">
          <li class="active"><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>interviewerLogout">Logout</a></li>
        </ul>
      </nav>
    </div>
        ...
        <div class="widget-content">
          <div>
            <ul class="filter-list">
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>interviewerAppliedCandidates">Applied Candidates</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>interviewerScheduledCandidates">Scheduled Candidates</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>interviewerInterviewedCandidates">Interviewed Candidates</a></li>
              <li> <a href="#">Interviewer Details <i class="fa fa-caret-down"></i></a>
                <ul>
                  <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>interviewerEditPassword">Update Password</a></li>
                  <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>interviewerEditProfile">Update Profile</a></li>
