      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 block-center">
          <ul class="one-step one clearfix">
            <li class="active">Reset Interviewer Password</li>
          </ul>
          <div class="white-container">
            <section>
              <div class="row">
               <div class="login-blocks">
                <form id="changeInterviewerPasswordForm" name="changeInterviewerPasswordForm" action="changeInterviewerPassword" method="post" onsubmit="return false;">
                  <div class="row">
                    <div class="col-sm-12">
                      <h6 class="label">Email Address</h6>
                      <input type="text" class="form-control" id="interviewerEmailId" name="interviewerEmailId" placeholder="Email Address" />
                      ...
                      <hr class="clear"/>
                      <button type="button" class="btn btn-default btn-large" id="changeInterviewerPasswordButton" name="changeInterviewerPasswordButton" >Reset Password</button>
                    </div>
                  </div>
                </form>
              </div>
