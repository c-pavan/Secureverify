    ...
    <div class="container"> 
      ...
      <nav>
        <ul class="primary-nav">
          <li class="active"><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>agentLogout">Logout</a></li>
        </ul>
      </nav>
    </div>
        ...
        <div class="widget-content">
          <div>
            <ul class="filter-list">
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>agentLocation" >Location</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>agentScheduleTimings">Add Schedule Timings</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>agentInterviewAppliedCandidates">Applied Candidates</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>agentInterviewerScheduledCandidates">Scheduled Candidates</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>agentInterviewedCandidates">Interviewed Candidates</a></li>
              <li> <a href="#" >My Account <i class="fa fa-caret-down"></i></a>
                <ul>
                  <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>editAgentPassword">Update Password</a></li>
                  <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>editAgentProfile">Update Profile</a></li>
...
<script src="<%=properties.getProperty("CONTEXT_PATH").toString() %>js/jquery.responsive-tabs.js"></script>
