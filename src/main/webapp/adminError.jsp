    ...
    <div class="container"> 
      ...
      <nav>
        <ul class="primary-nav">
          <li class="active"><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>adminLogout">Logout</a></li>
        </ul>
      </nav>
    </div>
        ...
        <div class="widget-content">
          <div>
            <ul class="filter-list">
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>adminInterviewer" >Interviewer</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>adminSkillSet">SkillSet</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>adminLocation">Location</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>adminAgent">Agent</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>adminCoupon">Coupon</a></li>
              <li> <a href="#" >My Account <i class="fa fa-caret-down"></i></a>
                <ul>
                  <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>adminViewProfile">View Profile</a></li>
                  <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>adminEditProfile">Edit Profile</a></li>
