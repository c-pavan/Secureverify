      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 block-center">
          <ul class="one-step one clearfix">
            <li class="active">Forgot Employer Password ?</li>
          </ul>
          <div class="white-container ">
            <section>
              <div class="row">
               <div class="login-blocks">
                <form id="forgotEmployerPasswordForm" name="forgotEmployerPasswordForm" action="resetEmployerPassword" method="post" onsubmit="return false;">
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <hr class="clear"/>
                      <button type="button" class="btn btn-default btn-large" id="forgotEmployerPasswordButton" name="forgotEmployerPasswordButton" >Submit</button>
                    </div>
                  </div>
                </form>
                </div>
