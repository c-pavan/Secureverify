    ...
    <div class="container"> 
      ...
      <nav>
        <ul class="primary-nav">
          <li class="active"><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>candidateLogout">Logout</a></li>
        </ul>
      </nav>
    </div>
        ...
        <div class="widget-content">
          <div>
            <ul class="filter-list">
              ...
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>candidateScheduleVerification">Schedule Verification</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>candidateScheduledTimeSlots">Scheduled Time Slots</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>candidateScheduledInterviews">Scheduled Interviews</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>candidateInterviewFeedback">Interview Feedback</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>candidateManageCertifications">Manage Certifications</a></li>
              <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>candidateEmployerScheduledInterview">Employer Scheduled Interview</a></li>
              <li> <a href="#">My Account <i class="fa fa-caret-down"></i></a>
                <ul>
                  <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>candidateUpdatePassword">Update Password</a></li>
                  <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>candidateUpdateProfile">Update Profile</a></li>
                  <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>visaDetails">Visa Details</a></li>
                  <li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>candidateCredits">Total Credits</a></li>
