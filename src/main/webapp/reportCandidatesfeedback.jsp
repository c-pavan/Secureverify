...
<html lang="en">
<head>
<title>Report Candidates | Secure Verify</title>
            ...
            <div class="col-xs-12 p0 green-bg">
              <div class="bottom-admin-line">
                <div class="col-sm-12 no-padding">
                  <h5 class="m0 clr-white pl25">Report Candidate Feedback</h5>
                </div>
              </div>
            </div>
            
            <form class="clear pt5" id="updateInterviewerCandidatesfeedbackForm" name="updateInterviewerCandidatesfeedbackForm" action="updateInterviewerCandidatesfeedback" method="post" onsubmit="return false;">
               ...
               <h6 class="label">Name</h6>
                ...
                <div class="row">
                 ...
                 <textarea class="form-control" rows="8" id="candidateFeedback" name="candidateFeedback"  placeholder="Candidate Feedback"></textarea>
                 </div>
               </div>
               <hr class="mt30" />
            <div class="clearfix">
              <button type="button" class="btn btn-success btn-large" id="updateInterviewerCandidatefeedbackButton" name="updateInterviewerCandidatefeedbackButton" >Submit Feedback &nbsp;<i class="fa fa-caret-right"></i></button>
            </div>
            </form>   
          </div>
        </div>
