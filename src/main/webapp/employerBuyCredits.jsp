      ...
      <div class="col-sm-9 page-content">
        <%@include file="includes/alertBoxSuccessError.jsp"%>
          <div class="white-container sign-up-form">
            ...
            <button type="button" class="btn btn-default btn-large mt10" id="submitEmployerPaymentForm" name="submitEmployerPaymentForm" onclick="submitEmployerPayment();" >Continue</button>
            
            </form>
            
            
           <form name="frmOrder" action="https://www.eProcessingNetwork.com/cgi-bin/dbe/transact.pl" method="post" > 
             <!-- <form name="frmOrder" action="buyEmployerCredits" method="get" > -->
					...
					<INPUT TYPE="HIDDEN" NAME="partyId" ID="partyId" VALUE="<s:property value="employer.employerId"/>" />
					<INPUT TYPE="HIDDEN" NAME="Company" ID="Company" VALUE="<s:property value="employer.employerCompanyName"/>" />
					<INPUT TYPE="HIDDEN" NAME="partyTypeId" ID="partyTypeId" VALUE="1" />
					...
					<INPUT TYPE="HIDDEN" NAME="ReturnApprovedURL" VALUE="http://www.secureverify.com/employerTransactionApproved" />
					<INPUT TYPE="HIDDEN" NAME="ReturnDeclinedURL" VALUE="http://www.secureverify.com/employerTransactionDeclined" />
