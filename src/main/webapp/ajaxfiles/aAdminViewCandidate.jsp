...
<div class="modal-dialog modal-lg">
  <div class="modal-content">
    ...
    <div class="modal-body viewform">
       ...
       <div class="viewlabel"><p class="labelspan">Name : </p> <p class="viewlabeldetails"> <s:property value="candidate.candidateFirstName" /> </p></div>
       <div class="viewlabel"><p class="labelspan">Registration Date : </p> <p class="viewlabeldetails"> <s:date name="candidate.creationDate" format="MM/dd/yyyy"/></p></div>
       <div class="viewlabel"><p class="labelspan">Interviewer Pickup Time : </p> <p class="viewlabeldetails"> <s:if test="candidateScheduleTiming.interviewStatus!=null && candidateScheduleTiming.interviewStatus!=0 && candidateScheduleTiming.interviewStatus!=1"><s:date name="candidateScheduleTiming.lastModifiedTime" format="MM/dd/yyyy hh:mm a" /></s:if></p></div>
       <div class="viewlabel"><p class="labelspan">Interviewer : </p> <p class="viewlabeldetails"> <s:property value="interviewer.interviewerFirstName" /> <s:property value="interviewer.interviewerLastName" /></p></div>
       <div class="viewlabel"><p class="labelspan">Interview Status : </p> <p class="viewlabeldetails"> <s:if test="candidateScheduleTiming.interviewStatus!=null && candidateScheduleTiming.interviewStatus==1">APPLIED</s:if><s:elseif test="candidateScheduleTiming.interviewStatus!=null && candidateScheduleTiming.interviewStatus==2">SCHEDULED</s:elseif><s:elseif test="candidateScheduleTiming.interviewStatus!=null && candidateScheduleTiming.interviewStatus==3">INTERVIEWED</s:elseif></p></div>
       <s:if test="candidateScheduleTiming.interviewStatus!=null && candidateScheduleTiming.interviewStatus==3"><div class="viewlabel"><p class="labelspan">Verification Id : </p> <p class="viewlabeldetails"> <s:property value="candidateScheduleTiming.candidateUniqueId" /></p></div></s:if>
       <div class="viewlabel"><p class="labelspan">Agent : </p> <p class="viewlabeldetails"> <s:property value="agent.agentFirstName" /> <s:property value="agent.agentLastName" /></p></div>
      ...
      <div class="col-md-7 col-sm-5 p0">
       ...
       <s:if test="candidateScheduleTiming.interviewStatus!=null && candidateScheduleTiming.interviewStatus==3">
       ...
       <div class="clear"></div>
       <s:if test="candidateScheduleTiming.interviewStatus!=null && candidateScheduleTiming.interviewStatus==2">
