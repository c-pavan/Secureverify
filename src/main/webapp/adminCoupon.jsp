...
<html lang="en">
<head>
<title>Admin Coupon | Secure Verify</title>
...
<%@include file="includes/header.jsp"%>
          ...
          <div class="green-bg">
            <div class="col-xs-12 green-bg-padding">
              <div class="bottom-admin-line">
                <div class="col-sm-9 no-padding">
                  <h5 class="m0 clr-white">Coupon Details</h5>
                </div>
                <div class="col-sm-3 p0 text-right mt5 mtnegative25 add-button-left">
                  <a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>addCoupon" class="btn btn-danger">Add Coupon</a>
                </div>
              </div>
            </div>
            <form id="admincouponSearchForm" class="green-bg-padding" name="admincouponSearchForm" action="#" method="post" onsubmit="return false;">
              ...
              <div class="col-sm-2 search-padding">
                <input type="text" class="datepicker form-control" id="fromDate" name="fromDate" placeholder="From Date">
              </div>
              <div class="col-sm-2 search-padding">
                <input type="text" class="datepicker form-control" id="toDate" name="toDate" placeholder="To Date">
              </div>
              <div class="col-sm-2 search-padding">
                <button type="button" class="btn btn-default height40 black-search-button" id="admincouponSearchButton" name="admincouponSearchButton" onclick = "javascript:searchAjx('adminSearchCouponAjax', 1);"><i class="fa fa-search"></i>Search</button>
              </div>
            </form>
            <div id="adminsearchcouponajax" class="table-responsive clear default-bg">
            <h6><strong>No. of Available Coupons: <span class="clr-red"><s:property value="totalSize" /></span></strong></h6>
                ...
                <tbody>
                 <s:if test="couponList!=null && couponList.size>0">
                  ...
                  <tr>
                    ...
                    <td>
                    	<a href="#" class="btn btn-success boxed-float-btn" data-toggle="modal" data-target="#viewcoupon"  onclick="javascript:callAjx('vCoupon',<s:property value="couponId" />);"><img src="<%=properties.getProperty("CONTEXT_PATH").toString() %>img/view-btn-img.png" alt="View" data-toggle="tooltip" title="View" /></a>
                      	<a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>editCoupon?couponId=<s:property value="couponId" />" class="btn btn-success boxed-float-btn"><img src="<%=properties.getProperty("CONTEXT_PATH").toString() %>img/edit-btn-img.png" alt="Edit" data-toggle="tooltip" title="Edit" /></a>
                      	<a href="#" class="btn btn-success boxed-float-btn" data-toggle="modal" data-target="#deletecoupon" onclick="javascript:callAjx('dCoupon',<s:property value="couponId" />);"><img src="<%=properties.getProperty("CONTEXT_PATH").toString() %>img/delete-btn-img.png" alt="Delete" data-toggle="tooltip" title="Delete" /></a>
                    </td>
                  </tr>
                   </s:iterator>
                  </s:if>
              ...
              <ul class="pagination">
				...
				<s:else><li><a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>adminCoupon?pageNo=<s:property value="(pageNo-1)" />"> <i class="fa fa-arrow-left"></i> Previous </a></li></s:else>
  ...
  <div class="modal fade" id="deletecoupon" role="dialog"></div>
<div class="modal fade" id="viewcoupon" role="dialog"></div>
