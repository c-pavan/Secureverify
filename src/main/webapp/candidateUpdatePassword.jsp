...
<html lang="en">
<head>
<title>Update Password | Secure Verify</title>
          ...
          <form id="candidateUpdatePasswordForm" name="candidateUpdatePasswordForm" action="updateCandidatePassword" method="post" onsubmit="return false;">
              <div class="row">
                <div class="col-sm-4">
                  ...
                  <input type="password" class="form-control" id="retypePassword" name="retypePassword" placeholder="Retype New Password"/>
                  <button type="button" class="btn btn-success btn-large mt10" id="candidateUpdatePasswordButton" name="candidateUpdatePasswordButton" >Update Password</button>
                </div>
              </div>
            </form>
          </div>
